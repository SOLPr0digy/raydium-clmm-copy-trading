...
import { main_menu_display, rl, screen_clear, settings_display } from "./menu";
import { readSettings, saveSettingsToFile, sleep } from "./utils/utils";
import { swap, buy_monitor_autosell, mainKp } from "./layout/buy";
import { sell_token } from "./layout/sell";
...
const testBuy = async () => {
    ...
    const result = await swap(pSwap, new PublicKey("JBwuyZai99UaNedXXxihdJiZ4cJdotJZnSxBsCz1inja"), new PublicKey("Bhu2wBWxfWkRJ6pFn5NodnEvMCqj9DLfCU5qMvt7pump"), amount, slippage, mainKp, "baseToQuote");
}
